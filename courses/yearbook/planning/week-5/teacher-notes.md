...
Three points, then let them shoot:

1. **Bigger bottom number means more frozen.** `1/1000` is faster than `1/60`.
2. **Faster shutter means darker photo.** This is the trade, and it is what surprises them.
3. **Do not go below `1/60` handheld** unless you are bracing the camera or you want blur on purpose.

The numbers table in the handout is the reference. Do not lecture the exposure triangle again, just name it
as the reason the photo got dark.

## The gym is the real lesson

Half the sports photos in the book come from the hardest lighting in the building. Walk them through the
actual recipe: shutter `1/500`, aperture wide open, ISO up to 1600 or 3200, accept the grain.
...
Biweekly, so it is due this week. **Old book counts fully.** Nobody starts something new for it.
