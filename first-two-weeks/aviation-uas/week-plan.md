...
|-----|-------|-----------|
| 01 Wed | Adobe licenses, Express intro, forms | About Me Square and documentation photos assigned |
| 02 Thu | Short policy hit, battery and aircraft safety, documentation photo standard | both in progress |
| 03 Fri | Part 107 walkthrough, room and equipment procedures | both due |
...
the ODOT course material). The preflight inspection lab folds into Thursday's prep and Friday's real preflight.
...
- Deferred to Unit 1.1: Quiz 1 (`assessments/quiz-1.md`), WebXam pretest (`../_shared/webxam-pretest.md`)
