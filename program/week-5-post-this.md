...
Everything that still needs to go out, by class, in the order it matters. **Each line is one post.**

Paths are inside `week-5-materials/` in the zip.
...
**If you only post one thing:** the project, since it has the requirement list and the two week plan.
...
| 5 | `2-video-and-sound/project.md` | **Assignment** |
| 6 | `2-video-and-sound/handouts/filming-day.md` | Material |
| 7 | `2-video-and-sound/handouts/camera-video-settings.md` | Material |

**If you only post one thing:** the equipment procedure. Everything else can wait a day.

**Before posting the worksheet:** open the two article links in Parts 1 and 2 and confirm they load. Backup
summary is built in if they do not.
...
**Already out:** your sectional worksheet. Today is finishing it.

**Reminder to say:** ODOT Module 1, due Thu Sep 24, is on next Friday's quiz.
...
**If you only post one thing:** the lab, since it is the step by step they work from.
...
| Post | File | Type |
|------|------|------|
| 1 | `5-yearbook/handouts/shutter-speed.md` | Material |
| 2 | `5-yearbook/project.md` | **Assignment**, due tomorrow |
| 3 | `5-yearbook/outline.md` | Material |
| 4 | `5-yearbook/vocab.md` | Material |

**Already out:** the assignment. These fill in the reference behind it.
