# TODAY (Tuesday Sep 8): Slide Prompts (all classes)

Four day week: Tue to Fri, Labor Day Monday off.

**How to use this:** every block below is **one prompt, for one slide.** Paste it into Google Slides AI
("Help me create") to generate that slide. Nothing here is a finished slide; these are the prompts.

**Every deck follows the same skeleton:**

1. **As You Come In** (what to open, what to do immediately)
2. **Standards + Today** (what standard we are on, what the agenda is)
3. **Content slides** (one idea each)
4. **Do Now** (before any work time or breakout)
5. **Before You Leave** (what is due, what is coming)
...
## 3. Aviation UAS: Footage review + real weather
...
## 4. Middle School CS: Loops (new content)

**Today's document:** `courses/middle-school-cs/planning/week-4/outline.md`
**Post:** nothing required; demo live in MakeCode Arcade.
**Go over:** intro loops (repeat and forever), contrasted with if statements. **The quiz is Friday, not today,
and does not cover loops.**

### Slide 1: As You Come In

> Create one "As You Come In" slide for a middle school computer science class. Big title: "As You Come In."
> Body: "Open MakeCode Arcade and start a new project. Question to think about: if you wanted the same three
> blocks to run four times in a row, would you drag them out four times? There is a better way, and we are
> learning it today." Large, clean, minimal. One slide.

### Slide 2: Standards + Today

> Create one agenda slide for a middle school computer science class titled "Today: Loops." Text: Today's
> skill is LOOPS, code that repeats, from the Ohio CS standards for Algorithmic Thinking and Programming,
> control structures. Agenda: 1) repeat vs forever, 2) how loops are different from if statements, 3) build one
> yourself. Add a box: "Friday's quiz covers IF STATEMENTS and everything before, NOT loops." Large readable
> text. One slide.

### Slide 3: repeat vs forever

> Create one slide for a middle school computer science class titled "Two Kinds of Loop." Show two code blocks
> in monospace. First, labeled REPEAT: "repeat 4 times: change score by 1" with the caption "runs exactly 4
> times, then stops." Second, labeled FOREVER: "forever: move the sprite" with the caption "keeps running as
> long as the game is running." One slide, large readable text.

### Slide 4: Loop vs conditional

> Create one slide for a middle school computer science class titled "Loop vs If." Two large statements side by
> side: "A LOOP repeats." and "An IF decides." Underneath: "These get mixed up constantly. They do completely
> different jobs. A loop runs the same code again. An if picks whether code runs at all." One slide.

### Slide 5: Do Now

> Create one "Do Now" slide for a middle school computer science class. Big title: "Do Now: Build a Loop."
> Body: "In MakeCode Arcade: 1) Build a FOREVER loop that moves a sprite back and forth. 2) Then build a REPEAT
...
> quiz is on if statements, not loops." One slide, large text.
